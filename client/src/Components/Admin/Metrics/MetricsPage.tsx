...
import { MetricsExportBtn } from './MetricsExportBtn'
import { useViewMetrics$ } from './MetricsQueries'
...
export const MetricsPage: FC = () => {
  ...
  const columns: GridColDef<ViewMetricsData>[] = [
    { field: 'title', headerName: 'Post Title', flex: 1 },
      ...
      <Paper sx={{ padding: 2 }}>
        <Stack gap={2}>
          ...
          <Stack gap={2} direction={'row'} justifyContent={'space-between'}>
            ...
            {metrics$.data && (
              <MetricsExportBtn metrics={metrics$.data} />
            )}
          </Stack>
        </Stack>
      </Paper>
