...
RSpec.describe "Pictures", type: :request do
  describe "GET index" do
    ...
    it "lists all pictures" do
      Post.create(date: Date.today, title: "test1", ext: ".png")
      Post.create(date: Date.today, title: "test2", ext: ".png")
  ...
  describe "GET view" do
    let(:picture) { Post.create(date: Date.today, title: "test", ext: ".png") }
