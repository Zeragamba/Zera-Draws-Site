...
type UseSortableResult<Data extends SortableData> = [
  order: Data[],
  move: MoveAction,
]
...
export function useSortable<Data extends SortableData>(
  items: Data[],
): UseSortableResult<Data> {
...
export function reorderItems<T extends SortableData>(
  items: T[],
  targetId: string,
